    ...
    private void createProductos() {
        ...
        List<Producto> productos = Arrays.asList(
            new Producto(null, "Hamburguesa Classic", 
                        ...
                        Arrays.asList("Carne de res", "Lechuga", "Tomate", "Cebolla", "Pan brioche", "Salsa especial"), null),
            ...
            new Producto(null, "Hamburguesa BBQ Deluxe", 
                        ...
                        Arrays.asList("Carne de res", "Bacon", "Queso cheddar", "Salsa BBQ", "Pan artesanal", "Cebolla caramelizada"), null),
            ...
            new Producto(null, "Hamburguesa Vegetariana", 
                        ...
                        Arrays.asList("Hamburguesa de lentejas", "Aguacate", "Lechuga", "Tomate", "Pan integral"), null),
            ...
            new Producto(null, "Perro Caliente Especial", 
                        ...
                        Arrays.asList("Salchicha premium", "Pan de perro", "Salsas especiales", "Cebolla", "Pepinillos"), null),
            ...
            new Producto(null, "Perro Caliente Supremo", 
                        ...
                        Arrays.asList("Salchicha premium", "Bacon", "Queso", "Aguacate", "Salsas gourmet"), null),
            ...
            new Producto(null, "Papas Fritas Grandes", 
                        ...
                        Arrays.asList("Papas frescas", "Sal marina"), null),
            ...
            new Producto(null, "Jugo de Naranja Natural", 
                        ...
                        Arrays.asList("Naranjas naturales"), null),
            ...
            new Producto(null, "Malteada de Chocolate", 
                        ...
                        Arrays.asList("Helado de vainilla", "Chocolate", "Leche", "Crema batida"), null),
            ...
            new Producto(null, "Malteada de Fresa", 
                        ...
                        Arrays.asList("Helado de vainilla", "Fresas", "Leche", "Crema batida"), null),
            ...
            new Producto(null, "Brownie con Helado", 
                        ...
                        Arrays.asList("Brownie casero", "Helado de vainilla", "Salsa de chocolate"), null),
            ...
            new Producto(null, "Hamburguesa Doble Cheese",
                ...
                Arrays.asList("Doble carne de res", "Queso cheddar", "Pan brioche", "Salsa especial"), null),
            new Producto(null, "Hamburguesa Chipotle",
                ...
                Arrays.asList("Carne de res", "Queso pepper jack", "Lechuga", "Mayonesa chipotle"), null),
            new Producto(null, "Hamburguesa Angus Premium",
                ...
                Arrays.asList("Carne Angus", "Queso suizo", "Cebolla caramelizada", "Pan artesanal"), null),
            new Producto(null, "Hamburguesa Pollo Crispy",
                ...
                Arrays.asList("Pechuga empanizada", "Lechuga", "Salsa tártara", "Pan brioche"), null),
            new Producto(null, "Hamburguesa Blue Cheese",
                ...
                Arrays.asList("Carne de res", "Queso azul", "Rúcula", "Cebolla"), null),
            new Producto(null, "Hamburguesa Mexicana",
                ...
                Arrays.asList("Carne de res", "Guacamole", "Jalapeños", "Queso", "Cebolla"), null),
            new Producto(null, "Hamburguesa Mini (Kids)",
                ...
                Arrays.asList("Carne de res pequeña", "Queso", "Pan pequeño"), null),
            new Producto(null, "Perro Callejero",
                ...
                Arrays.asList("Salchicha", "Pan de perro", "Salsa de la casa", "Cebolla"), null),
            new Producto(null, "Perro Picante",
                ...
                Arrays.asList("Salchicha", "Pan", "Salsa picante", "Jalapeños", "Limón"), null),
            new Producto(null, "Perro con Queso Fundido",
                ...
                Arrays.asList("Salchicha premium", "Queso fundido", "Pan"), null),
            new Producto(null, "Perro Veggie",
                ...
                Arrays.asList("Salchicha vegetal", "Lechuga", "Tomate", "Pan integral"), null),
            new Producto(null, "Yuca Frita",
                ...
                Arrays.asList("Yuca", "Sal", "Salsa de ajo"), null),
            new Producto(null, "Mozzarella Sticks",
                ...
                Arrays.asList("Queso mozzarella", "Empanizado", "Salsa marinara"), null),
            new Producto(null, "Ensalada César",
                ...
                Arrays.asList("Lechuga romana", "Aderezo César", "Crutones", "Queso parmesano"), null),
            new Producto(null, "Aros de Yuca",
                ...
                Arrays.asList("Yuca", "Empanizado", "Especias"), null),
            new Producto(null, "Ensalada de Papas",
                ...
                Arrays.asList("Papas", "Mayonesa", "Cebolla", "Perejil"), null),
            new Producto(null, "Combo Acompañamiento (Papas + Aros)",
                ...
                Arrays.asList("Papas fritas", "Aros de cebolla"), null),
            new Producto(null, "Pan con Ajo",
                ...
                Arrays.asList("Pan", "Mantequilla de ajo"), null),
            new Producto(null, "Limonada Natural",
                ...
                Arrays.asList("Limón", "Agua", "Azúcar"), null),
            new Producto(null, "Té Helado",
                ...
                Arrays.asList("Té negro", "Hielo", "Azúcar opcional"), null),
            new Producto(null, "Malteada Vainilla",
                ...
                Arrays.asList("Helado de vainilla", "Leche", "Crema"), null),
            new Producto(null, "Cerveza Artesanal 330ml",
                ...
                Arrays.asList("Cerveza artesanal"), null),
            new Producto(null, "Cheesecake",
                ...
                Arrays.asList("Queso crema", "Galleta", "Mermelada"), null),
            new Producto(null, "Tiramisú",
                ...
                Arrays.asList("Queso mascarpone", "Café", "Bizcocho"), null),
            new Producto(null, "Helado Copa",
                ...
                Arrays.asList("Helado", "Toppings"), null),
            new Producto(null, "Galletas Calientes",
                ...
                Arrays.asList("Harina", "Azúcar", "Mantequilla", "Chispas de chocolate"), null)
);
