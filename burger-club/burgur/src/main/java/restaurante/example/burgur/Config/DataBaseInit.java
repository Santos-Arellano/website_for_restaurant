...
public class DataBaseInit implements CommandLineRunner {
    ...
    private void createProductos() {
        ...
        List<Producto> productos = Arrays.asList(
            ...
            // Nuevas
            new Producto("Hamburguesa Doble Cheese",
                ...
                Arrays.asList("Doble carne de res", "Queso cheddar", "Pan brioche", "Salsa especial")),
            new Producto("Hamburguesa Chipotle",
                ...
                Arrays.asList("Carne de res", "Queso pepper jack", "Lechuga", "Mayonesa chipotle")),
            new Producto("Hamburguesa Angus Premium",
                "Carne Angus, queso suizo y cebolla caramelizada",
                30000.0, "hamburguesa", "/images/menu/angus.png", 10, false, true, true,
                Arrays.asList("Carne Angus", "Queso suizo", "Cebolla caramelizada", "Pan artesanal")),
            new Producto("Hamburguesa Pollo Crispy",
                ...
                Arrays.asList("Pechuga empanizada", "Lechuga", "Salsa tártara", "Pan brioche")),
            new Producto("Hamburguesa Blue Cheese",
                ...
                Arrays.asList("Carne de res", "Queso azul", "Rúcula", "Cebolla")),
            new Producto("Hamburguesa Mexicana",
                "Con guacamole, jalapeños y salsa picante casera",
                23000.0, "hamburguesa", "/images/menu/mex-burger.png", 16, false, true, true,
                Arrays.asList("Carne de res", "Guacamole", "Jalapeños", "Queso", "Cebolla")),
            new Producto("Hamburguesa Mini (Kids)",
                ...
                Arrays.asList("Carne de res pequeña", "Queso", "Pan pequeño")),
            new Producto("Perro Callejero",
                ...
                Arrays.asList("Salchicha", "Pan de perro", "Salsa de la casa", "Cebolla")),
            new Producto("Perro Picante",
                "Con salsa picante, jalapeños y toque de limón",
                11000.0, "perro caliente", "/images/menu/spicy-dog.png", 35, false, true, true,
                Arrays.asList("Salchicha", "Pan", "Salsa picante", "Jalapeños", "Limón")),
            new Producto("Perro con Queso Fundido",
                ...
                Arrays.asList("Salchicha premium", "Queso fundido", "Pan")),
            new Producto("Perro Veggie",
                ...
                Arrays.asList("Salchicha vegetal", "Lechuga", "Tomate", "Pan integral")),
            new Producto("Yuca Frita",
                "Yuca crocante, servida con salsa de ajo",
                4800.0, "acompañamiento", "/images/menu/yuca-frita.png", 35, false, false, true,
                Arrays.asList("Yuca", "Sal", "Salsa de ajo")),
            new Producto("Mozzarella Sticks",
