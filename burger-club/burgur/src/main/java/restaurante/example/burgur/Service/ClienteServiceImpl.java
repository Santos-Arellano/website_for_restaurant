...
public class ClienteServiceImpl implements ClienteService {
    ...
    public void validarCliente(Cliente c) {
        ...
        validateNombreCliente(c);
        validateApellidoCliente(c);
        validateCorreoCliente(c);
        validateContrasenaCliente(c);
        validateTelefonoCliente(c);
        validateDireccionCliente(c);
        
        // Normalización de campos
        normalizeClienteData(c);
    }
    
    private void validateNombreCliente(Cliente c) {
    ...
    private void validateApellidoCliente(Cliente c) {
    ...
    private void validateCorreoCliente(Cliente c) {
    ...
    private void validateTelefonoCliente(Cliente c) {
    ...
    private void validateDireccionCliente(Cliente c) {
    ...
    private void normalizeClienteData(Cliente c) {
